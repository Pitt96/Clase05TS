...
var getAvenger = function (_a) {
    var nombre = _a.nombre, poder = _a.poder, _b = _a.arma, arma = _b === void 0 ? 'arco' : _b;
    return "Nombre: ".concat(nombre, ", Poder: ").concat(poder || 'No esta definido', ", Arma: ").concat(arma);
};
var mensaje = getAvenger({ nombre: 'Jose', arma: 'pistola' });
